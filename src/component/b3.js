...
function App() {
  ...
  //   let date = element.intensity
  //   console.log(date)

  // });
  // console.log(Math.max(new Date(data.added).getFullYear()))
  // d3.json("https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/GDP-data.json")
  // !! IMPORTANT README:

  // http://192.168.1.5:4000/api/data
  // http://localhost:5000/api/statistics
  // Fetch the data from the provided URL
  d3.json("http://localhost:5000/api/statistics")
    .then(data => {
